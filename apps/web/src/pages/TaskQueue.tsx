...
export function TaskQueue() {
  ...
  // S12 B.2 — `placeholderData` shows MOCK_TASKS immediately, then the
  // real fetch (when successful) replaces it. On fetch error, `data` stays
  // undefined and we fall back to MOCK_TASKS so the queue never blanks out.
